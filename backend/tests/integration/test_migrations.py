...
def test_upgrade_preserves_data_and_failure_rolls_back(database_url, migrate, tmp_path):
    ...
    try:
        ...
        # 临时复制迁移链，注入 DDL 执行到一半失败，不修改正式迁移。
        ...
        (scripts / "versions" / "0003_failure.py").write_text(
